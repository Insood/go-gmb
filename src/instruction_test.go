...
func TestPopHL(t *testing.T) {
	...
	cpu.cart.write8(0x1000, 0x55)
	cpu.cart.write8(0x1001, 0x33)
	cpu.programCounter = 0x100
	cpu.cart.write8(0x100, 0xE1)
	pop(cpu)
...
func TestPopAF(t *testing.T) {
	cpu := testCPU()
	cpu.stackPointer = 0x1000
	cpu.cart.write8(0x1000, 0xA0) // F - zero & half carry are set
	cpu.cart.write8(0x1001, 0x33) // rA value
	cpu.programCounter = 0x100
	cpu.cart.write8(0x100, 0xF1) // POP AF
	pop(cpu)
	if cpu.ra != 0x33 {
